<footer class="bg-neutral-primary-soft border-t border-gray-300">
    <div class="mx-auto w-full p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="/" class="flex items-center">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="h-7 me-3" alt="Logo FlowBite" />
                    <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap">ImmoPro</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Ressources</h2>
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Suivez-nous</h2>
                    <ul class="text-body font-medium">
                        <li class="mb-4">
        ...
        <hr class="border-t border-gray-300 sm:mx-auto lg:my-8 py-2" />
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-body sm:text-center">© 2023 <a href="https://flowbite.com/"
                    class="hover:underline">ImmoPro</a>. Tous droits réservés.
            </span>
            <div class="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <a href="#" class="text-body hover:text-heading ms-5">
                    ...
                    <span class="sr-only">Compte GitHub</span>
                </a>
                <a href="#" class="text-body hover:text-heading ms-5">
                    <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="sr-only">Compte Dribbble</span>
                </a>
            </div>
        </div>
    </div>
