<div class="grid lg:grid-cols-2 items-start gap-5 md:gap-16 my-10 mx-auto bg-purple-50 rounded-2xl p-6 border-[#112d6e] border">
    <div>
    ...
    <form class="lg:ml-auto space-y-4" wire:submit.prevent='save'>
        ...
        <div class="flex justify-center">
            <button type="submit"
                class="bg-[#112d6e] text-white mt-3 font-semibold px-3 py-2 rounded-2xl hover:from-[#112d6e] hover:to-[#112d6e] active:scale-95 transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg w-full max-w-xs text-center">
                Envoyer le message
            </button>
        </div>
    </form>
