<form action="" method="GET"
    ...
    {{-- Search Button --}}
    <button type="submit"
        class="bg-purple-600 text-white font-semibold px-4 py-3 rounded-2xl hover:bg-purple-700 active:scale-95 transition-all duration-200 flex items-center gap-2 shadow-md hover:shadow-lg mr-3">
