<form action="/" method="GET"
    ...
    {{-- City --}}
    <div
        class="flex items-center px-4 py-1 border-r border-gray-200 hover:bg-gray-50/50 transition-colors rounded-l-2xl min-w-[180px]">
        <svg class="w-4 h-4 text-[#112d6e] mr-2.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"
            stroke-width="2">
    ...
    {{-- Type --}}
    <div
        class="flex items-center px-4 py-1 border-r border-gray-200 hover:bg-gray-50/50 transition-colors min-w-[180px]">
        <svg class="w-4 h-4 text-[#112d6e] mr-2.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"
            stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{-- Search Button --}}
    <button type="submit"
        class="bg-[#112d6e] text-white font-semibold px-4 py-3 rounded-2xl hover:bg-[#112d6e] active:scale-95 transition-all duration-200 flex items-center gap-2 shadow-md hover:shadow-lg mr-3">
